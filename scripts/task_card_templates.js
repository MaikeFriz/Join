  ...
  return /*html*/`
    ...
    <div class="focused-task">
      ...
      <div class="focused-edit-trash">
        ...
        <div class="focused-trash" onclick="confirmDelete('${taskContent.taskId}')">
...
function confirmDelete(taskId) {
  const confirmed = confirm("Bist du sicher, dass du diese Aufgabe löschen möchtest?");
  if (confirmed) {
    deleteTask(taskId); // <- Deine eigene Delete-Logik hier
  }
}
