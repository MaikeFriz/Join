function generateDropdownOptionTemplate(initials, userName, firstLetter, isChecked) {
    return `
...
function generateAssigneeTemplate(userId, initials, firstLetter) {
    return `
...
function generateEditIconsTemplate() {
    return `
...
function getSubtaskHtmlTemplate(subtaskText) {
  return `
