    ...
    return /*html*/`
      ...
      <div class="focused-task">
        ...
        <div class="focused-task-top">
          ...
          <svg onclick="fromFocusedTaskToBoard()" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="focused-edit-trash">
          ...
          <div class="focused-edit" onclick="getKanbanData(), fromFocusedToEditTask('${taskContent.taskId}')">
