...
function editTaskTemplate(displayedDueDate, label, fitLabelForCSS, title, description, createAt, priority, taskId) {
  return /*html*/`
      <div class="edit-task" onclick="closeDropdownOnOutsideClick(event)">
        ...
        <div class="ok-button">
          <button type="button" class="clear_button_div" onclick="saveEditedTask('${taskId}');fromEditTaskToBoard()">
            <p>Ok</p>
...
function editSubtaskTemplate(subtaskId, subtaskData) {
  return `
    <div class="edit-subtask-item">
      ...
      <svg onclick="removeEditSubtask('${subtaskId}', '${subtaskData.title}')" width="18" height="17" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
